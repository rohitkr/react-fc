...
/*** Onload ***/
(0, _jquery2['default'])('.navigation-tab').on('click', function () {
    var url = window.location.href,
        index = url.indexOf('/#'),
        id = (0, _jquery2['default'])(this)[0].id;
...
(0, _jquery2['default'])('.examples').on('click', function () {
    var url = window.location.href,
    ...
    (0, _jquery2['default'])('#html_code code.language-markup').html(code[exampleId].html);
    (0, _jquery2['default'])('#javascript_code code.language-javascript').html(code[exampleId].javascript);
...
},{"bootstrap":2,"fusioncharts":undefined,"fusioncharts/fusioncharts.charts":15,"fusioncharts/fusioncharts.powercharts":16,"jquery":17,"prismjs":18,"react":undefined,"react-dom":undefined,"react-fc":undefined}],2:[function(require,module,exports){
